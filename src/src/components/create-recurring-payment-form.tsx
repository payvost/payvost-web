...
export function CreateRecurringPaymentForm({ onBack }: CreateRecurringPaymentFormProps) {
    ...
    const onSubmit: SubmitHandler<RecurringPaymentFormValues> = async (data) => {
        ...
        toast({
            ...
            description: `Recurring payment to ${data.recipient} has been set up.`,
        });
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                    ...
                                    <SelectContent>
                                        <SelectItem value="John Doe (USA)">John Doe (USA)</SelectItem>
                                        <SelectItem value="Landlord (Rent)">Landlord (Rent)</SelectItem>
                                        <SelectItem value="Netflix Subscription">Netflix Subscription</SelectItem>
                                    </SelectContent>
                                </Select>
                            )}
                        />
