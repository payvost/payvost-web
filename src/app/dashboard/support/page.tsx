...
export default function SupportPage() {
  ...
  return (
    <DashboardLayout language={language} setLanguage={setLanguage}>
      <main className="flex flex-1 flex-col items-center justify-start w-full">
        {/* Hero Section */}
        ...
        <section className="w-full py-12 md:py-20 lg:py-24">
          <div className="max-w-6xl mx-auto px-4 md:px-6">
            <h2 className="text-center text-2xl md:text-3xl font-bold mb-10">Browse by Category</h2>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {supportCategories.map((category) => (
                <Card key={category.title} className="hover:shadow-lg transition-shadow text-center">
        ...
        <section className="w-full mb-24">
          <div className="max-w-6xl mx-auto px-4 md:px-6 grid gap-12 lg:grid-cols-3">
            {/* Featured Articles */}
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-bold mb-6 text-center lg:text-left">Featured Articles</h2>
