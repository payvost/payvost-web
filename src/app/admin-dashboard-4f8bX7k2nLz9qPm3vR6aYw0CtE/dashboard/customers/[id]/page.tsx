...
const businessOwnerDetails: CustomerData = {
    id: 'usr_1',
    name: 'Liam Johnson',
    ...
    totalSpend: 12500,
    associatedAccounts: [
        { id: 'biz_1', name: 'Tech Innovators Inc.', type: 'Business' }
    ],
    wallets: [
        { currency: 'USD', balance: 5230.50 },
        { currency: 'GBP', balance: 1200.00 },
    ],
    transactions: [
        { id: 'txn_1', type: 'inflow', amount: 5000, currency: 'USD', status: 'succeeded', date: '2024-08-15' },
        { id: 'txn_2', type: 'outflow', amount: 250, currency: 'USD', status: 'succeeded', date: '2024-08-14' },
    ],
};

const normalUserDetails: CustomerData = {
    id: 'usr_3',
    name: 'Noah Williams',
    ...
    totalSpend: 850,
    wallets: [
        { currency: 'NGN', balance: 150000.00 },
        { currency: 'USD', balance: 150.25 },
    ],
    transactions: [
        { id: 'txn_10', type: 'inflow', amount: 200000, currency: 'NGN', status: 'succeeded', date: '2024-08-12' },
        { id: 'txn_11', type: 'outflow', amount: 50000, currency: 'NGN', status: 'succeeded', date: '2024-08-10' },
    ],
    associatedAccounts: [],
};
...
export default function CustomerDetailsPage({ params }: { params: { id: string } }) {
    ...
    // Here we simulate it by choosing the mock data based on the ID.
    const customer = params.id === 'usr_3' ? normalUserDetails : businessOwnerDetails;
    const status = kycStatusConfig[customer.kycStatus];
                ...
                <div className="lg:col-span-2 space-y-6">
                     <Card>
                        ...
                        <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                            ...
                            <div><p className="text-muted-foreground flex items-center gap-1"><Calendar className="h-4 w-4" /> Joined</p><p className="font-medium pl-5">{customer.joinedDate}</p></div>
                        </CardContent>
                    </Card>
