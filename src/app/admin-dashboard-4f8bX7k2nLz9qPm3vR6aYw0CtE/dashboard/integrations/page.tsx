          ...
          <TabsContent value="marketplace" className="mt-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Connect Qwibik Remit with your favorite tools and services.</CardDescription>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {integrations.map(app => (
                            <Card key={app.name} className="flex flex-col">
                                ...
                                <CardFooter>
                                    <Button asChild>
                                        <Link href={`/admin-dashboard-4f8bX7k2nLz9qPm3vR6aYw0CtE/dashboard/integrations/${app.slug}`}>Connect</Link>
                                    </Button>
                                </CardFooter>
                            </Card>
                        ))}
