...
export default async function LegacyInvoiceLinkPage(props: { params: Promise<{ id: string }> }) {
    ...
    <main className="min-h-[60vh] flex items-center justify-center p-6 bg-muted/10">
      <Card className="max-w-xl w-full">
        ...
        <CardContent className="text-sm text-muted-foreground">
          This invoice link is no longer available. Please request a new secure invoice link from the sender.
        </CardContent>
      </Card>
    </main>
  );
