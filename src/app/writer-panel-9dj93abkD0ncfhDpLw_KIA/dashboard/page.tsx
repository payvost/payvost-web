  ...
  const quickActions = [
    {
      ...
      href: '/writer-panel-9dj93abkD0ncfhDpLw_KIA/dashboard/content/blog/new',
      color: 'bg-blue-500',
    },
    {
      title: 'Press Release',
      ...
      href: '/writer-panel-9dj93abkD0ncfhDpLw_KIA/dashboard/content/press/new',
      color: 'bg-green-500',
    },
    {
      title: 'Documentation',
      ...
      href: '/writer-panel-9dj93abkD0ncfhDpLw_KIA/dashboard/content/docs/new',
      color: 'bg-purple-500',
    },
    {
      ...
      href: '/writer-panel-9dj93abkD0ncfhDpLw_KIA/dashboard/content/knowledge-base/new',
      color: 'bg-orange-500',
    },
  ];
