...
exports.isMailgunConfigured = isMailgunConfigured;
exports.sendEmail = sendEmail;
exports.sendBatchEmail = sendBatchEmail;
exports.generateRateAlertEmailHTML = generateRateAlertEmailHTML;
 ...
 */
async function sendBatchEmail(recipients, subject, html, text, options) {
    return sendEmail({
        ...options,
        to: recipients,
        subject,
 ...
 */
function generateRateAlertEmailHTML(params) {
 ...
 */
async function sendRateAlertEmail(to, subject, text, htmlParams) {
