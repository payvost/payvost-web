 ...
 */
app.post('/analyze-transaction', verifyInternalAuth, async (req: Request, res: Response) => {
  try {
 ...
 */
app.get('/risk-score/:accountId', verifyInternalAuth, async (req: Request, res: Response) => {
  try {
 ...
 */
app.get('/alerts', verifyInternalAuth, async (req: Request, res: Response) => {
  try {
 ...
 */
app.post('/alerts/:id/resolve', verifyInternalAuth, async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
