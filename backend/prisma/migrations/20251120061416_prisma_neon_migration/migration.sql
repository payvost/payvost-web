...
-- DropIndex
DROP INDEX "public"."RateAlert_email_idx";

-- DropIndex
DROP INDEX "public"."RateAlert_email_key";

-- DropIndex
DROP INDEX "public"."RateAlert_sourceCurrency_targetCurrency_idx";

-- AlterTable
ALTER TABLE "RateAlert" ALTER COLUMN "targetRate" SET DATA TYPE DECIMAL(65,30);
